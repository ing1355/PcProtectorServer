...
public class UserService {
    ...
    @Transactional
    public String registryFromAdminList(UserExcelVO userExcelVO, String User_Idx) {
        userMapper.deleteAllUserInfo(User_Idx);
        String new_rootIdx = departmentService.registerByExcel(userExcelVO.getDepartmentList(), User_Idx);
        log.info("-------------------------");
